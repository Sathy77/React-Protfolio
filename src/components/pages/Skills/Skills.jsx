    ...
    <div className="h-full page-shadow bg-white px-10">
      <div>
        ...
        <div className="h-[500px] overflow-y-scroll">
          ...
          <SkillsLevel skillName="C++" percentage="95%" />
          <SkillsLevel skillName="Python" percentage="80%" />
          <SkillsLevel skillName="HTML,CSS" percentage="95%" />
          <SkillsLevel skillName="Django" percentage="80%" />
          <SkillsLevel skillName="PostgreSQL" percentage="80%" />
          <SkillsLevel skillName="Unreal Engine (Game)" percentage="80%" />
          <SkillsLevel skillName="PostgreSQL" percentage="80%" />
          <SkillsLevel skillName="Unreal Engine (Game)" percentage="80%" />
